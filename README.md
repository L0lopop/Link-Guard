...
- **проверка обновлений** — раз в сутки читает `update.json` из этого репозитория; если вы согласитесь обновиться, файл плагина скачивается и отправляется вам в «Избранное».
